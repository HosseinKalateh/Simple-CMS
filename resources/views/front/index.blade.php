                            ...
                            @foreach($posts as $post)
                                <div class="col-md-6">
                                    <div class="card border hover-shadow-6 mb-6 d-block">
                                        <a href="{{ route('front.post.show', $post->id) }}"><img class="card-img-top" src="{{ asset($post->image) }}" alt="Card image cap"></a>
...
{{--                        <h6 class="sidebar-title">{{ __('words.search') }}</h6>--}}
{{--                        <form class="input-group" action="{{ route('front.post.index') }}"  method="GET">--}}
{{--                            <input type="text" class="form-control" name="s" placeholder="{{ __('words.search') }}">--}}
{{--                            <div class="input-group-addon">--}}
{{--                                <button style="submit"><span class="input-group-text"><i class="ti-search"></i></span></button>--}}
{{--                            </div>--}}
{{--                        </form>--}}
