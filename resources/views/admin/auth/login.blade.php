        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.login.login') }}" method="POST">
                ...
                <div class="form-group">
                    <input class="form-control form-control-lg" name="email" id="email" type="text" placeholder="@Lang('words.email')" autocomplete="off">
                </div>
                <div class="form-group">
                    <input class="form-control form-control-lg" name="password" id="password" type="@Lang('words.password')" placeholder="Password">
                </div>
